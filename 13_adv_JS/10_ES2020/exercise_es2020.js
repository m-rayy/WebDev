...
// +/- ~9,000,000,000,00(0,000)
console.log(Number.MAX_SAFE_INTEGER)
console.log(Number.MIN_SAFE_INTEGER)

// Exercise 2: why does this throw an error? How can you fix it?
// 3 + 4 + 1n -> "Cannot mix BigInt and other types, use explicit conversions "
...
// Fail:
if (andrei_pokemon?.dummy && will_pokemon?.pikachu?.friend?.charizard) {
    console.log('fight!')
} else {
    console.log('walk away...')
}
